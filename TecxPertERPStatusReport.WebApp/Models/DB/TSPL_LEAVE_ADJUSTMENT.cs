...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_LEAVE_ADJUSTMENT
    {
        public string LVADJUSTMENT_CODE { get; set; }
        public string EMP_CODE { get; set; }
        public System.DateTime ADJUSTMENT_DATE { get; set; }
        public string PAY_PERIOD_CODE { get; set; }
        public string LEAVE_CODE { get; set; }
        public string LEAVE_REASON { get; set; }
        public decimal ADJUST_ALLOTED { get; set; }
        public decimal ADJUST_AVAILED { get; set; }
