...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_INCREMENT_DETAIL
    {
        public string INCREMENT_CODE { get; set; }
        public string EMP_CODE { get; set; }
        public string PAY_HEAD_CODE { get; set; }
        public decimal LAST_RATEAMOUNT { get; set; }
        public decimal INCREMENT_RATEAMOUNT { get; set; }
        public decimal INCREMENTED_RATEAMOUNT { get; set; }
