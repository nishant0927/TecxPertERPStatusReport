...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_MCC_SAMPLE_QC_DETAIL
    {
        public string DOC_CODE { get; set; }
        public string QC_VLC_DOC_CODE { get; set; }
        ...
        public string Sample_VLC_DOC_CODE { get; set; }
        public string MILK_SRN_CODE { get; set; }
    
        public virtual TSPL_ITEM_MASTER TSPL_ITEM_MASTER { get; set; }
        public virtual TSPL_MCC_SAMPLE_QC_HEAD TSPL_MCC_SAMPLE_QC_HEAD { get; set; }
