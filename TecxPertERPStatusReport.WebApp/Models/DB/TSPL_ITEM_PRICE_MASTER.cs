...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_ITEM_PRICE_MASTER
    {
        ...
        public decimal Item_Selling_Price { get; set; }
        public string Item_Basic_Price_Type { get; set; }
        public string Markup_On { get; set; }
        public decimal Markup_Percent { get; set; }
        public decimal Landing_Cost { get; set; }
        public string Tax_Manipulation_On { get; set; }
        public decimal Purchase_Cost { get; set; }
        public string Basic_Price_On { get; set; }
        public string Location_Code { get; set; }
        public string Is_With_Tax { get; set; }
        public int Is_Active { get; set; }
        public string Stock_Price_Id { get; set; }
        public string Type { get; set; }
        public int Posted { get; set; }
        public string Posted_By { get; set; }
        public Nullable<System.DateTime> Posted_Date { get; set; }
        public string Against_Plan_TR_Code { get; set; }
        public string Against_ItemwiseTaxCode { get; set; }
    
        public virtual TSPL_ITEM_MASTER TSPL_ITEM_MASTER { get; set; }
        public virtual TSPL_ITEM_PRICE_PLAN_DETAIL TSPL_ITEM_PRICE_PLAN_DETAIL { get; set; }
