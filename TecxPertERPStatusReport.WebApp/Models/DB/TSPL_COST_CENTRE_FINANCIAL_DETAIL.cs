...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_COST_CENTRE_FINANCIAL_DETAIL
    {
        public string Cost_Center_Fin_Code { get; set; }
        public string Cost_Center_Fin_Level_Code { get; set; }
        public string Cost_Center_Fin_Level_Name { get; set; }
