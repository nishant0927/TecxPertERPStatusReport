...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_MILK_RGP_DETAIL
    {
        ...
        public Nullable<double> FAT_Price { get; set; }
        public Nullable<double> SNF_Price { get; set; }
        public string Remarks { get; set; }
        public string To_Location_Code { get; set; }
        public int To_SubLocation_YN { get; set; }
        public string Tanker_No { get; set; }
        public Nullable<double> FAT_Cost { get; set; }
        public Nullable<double> SNF_Cost { get; set; }
        public string Bulk_Milk_SRN_Code { get; set; }
        ...
        public virtual TSPL_MILK_RGP_HEAD TSPL_MILK_RGP_HEAD { get; set; }
