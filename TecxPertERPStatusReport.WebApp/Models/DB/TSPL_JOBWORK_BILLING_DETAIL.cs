...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_JOBWORK_BILLING_DETAIL
    {
        public string Document_Code { get; set; }
        public int Line_No { get; set; }
        public string JW_EstimationNo { get; set; }
        public string Item_Code { get; set; }
        public string Item_Desc { get; set; }
        public string Unit_code { get; set; }
        public Nullable<decimal> Invoice_Qty { get; set; }
        public Nullable<decimal> ConvKG_Qty { get; set; }
        public Nullable<decimal> FATKg { get; set; }
        public Nullable<decimal> SNFKg { get; set; }
        public Nullable<decimal> price { get; set; }
        public Nullable<decimal> ConvKG_Price { get; set; }
        ...
        public string JWI_Price_Code { get; set; }
