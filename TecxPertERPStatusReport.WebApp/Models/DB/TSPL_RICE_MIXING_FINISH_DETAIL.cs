...
namespace TecxPertERPStatusReport.WebApp.Models.DB
{
    ...
    public partial class TSPL_RICE_MIXING_FINISH_DETAIL
    {
        ...
        public Nullable<double> Mixing_Amount { get; set; }
        public Nullable<double> Total_Cost { get; set; }
        public string Lot_No { get; set; }
        public string Remarks { get; set; }
    
        public virtual TSPL_ITEM_MASTER TSPL_ITEM_MASTER { get; set; }
        public virtual TSPL_RICE_MIXING_HEAD TSPL_RICE_MIXING_HEAD { get; set; }
